    ...
    <div class="container px-4 px-lg-5">
        <c:choose>
            <c:when test="${signInSuccess}">
                <!-- Display ussername in navbar if signed in -->
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto my-2 my-lg-0">
                <li class="nav-item"><a class="nav-link" href="logIn">Signup/Login</a></li>
                <li class="nav-item"><a class="nav-link" href="displayStories">Read</a></li>
