...
class StoryTest {
    ...
    public void testGet() throws Exception {
       ...
       // logger.info("actual storyId: " + story.getStoryId());
        //logger.info("retrieved storyId: " + retrievedStory.getStoryId());
        //logger.info("actual title: " + story.getTitle());
        //logger.info("retrieved title: " + retrievedStory.getTitle());
